...
let _close = false;
let _fsj = false;
var url = 'https://tbfsl.github.io/static/image/0127.png';
...
function shareText(score) {
    ...
    if (score <= 2.5 * __Time) return '均值不等式';
    if (score <= 5 * __Time) return '作业我阐释你的梦';
    if (score <= 7.5 * __Time) return 'byd冷雨夜';
    if (score <= 10 * __Time) return '你是个啥？';
    return '你怎么死了';
}
